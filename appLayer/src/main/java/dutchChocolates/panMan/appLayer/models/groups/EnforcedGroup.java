...
public class EnforcedGroup extends Group {

    public EnforcedGroup() {
        super();
    }

    public EnforcedGroup(UUID identifier, User creator, ArrayList<User> participants, Schedule schedule) {
